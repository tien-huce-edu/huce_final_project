    ...
    <>
      {isLoading ? (
        ...
        <div className="w-full h-full 1000px:flex items-center">
          <div className="absolute top-[100px] 1000px:top-[unset] 1500px:h-[600px] 1500px:w-[600px] 1100px:h-[500px] 1100px:w-[600px] h-[50vh]  w-[100vw] hero_animation rounded-[50%] 1100px:left-8 1500px:left-[1rem]"></div>
          <div className="1000px:w-[40%] flex 1000px:min-h-screen items-center justify-end pt-[70px] 1000px:pt-[0] z-10">
            <Image
              ...
              height={400}
              alt=""
              className="object-contain w-[90%] 1100px:max-w-[90%]  1500px:max-w-[85%] h-[auto] z-[10]"
            />
          </div>
