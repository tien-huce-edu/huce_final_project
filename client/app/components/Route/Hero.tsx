...
import Client1 from "../../../public/assets/image/client/client-1.jpg";
import Client2 from "../../../public/assets/image/client/client-2.jpg";
import Client3 from "../../../public/assets/image/client/client-3.jpg";
  ...
  return (
    <div className="w-full 1000px:flex items-center">
      ...
      <div className="1000px:w-[40%] flex 1000px:min-h-screen items-center justify-end pt-[70px] 1000px:pt-[0] z-10">
        <Image
          src={require("../../../public/assets/image/banner/banner-img-1.png")}
          width={400}
          height={400}
          alt="Hero Image"
